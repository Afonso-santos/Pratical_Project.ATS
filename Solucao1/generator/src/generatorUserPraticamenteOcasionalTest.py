...
class UtilizadorPraticanteOcasionalJUnitTestGenerator:
    def __init__(self, path="../Projeto/generatorTest/Utilizador/", filename="UtilizadorPraticanteOcasionalGenTest.java"):
        self.path = path
    ...
    def _codigo_inicial(self):
        return '''package Projeto.test.UtilizadorPraticanteOcasional;
...
class UtilizadorPraticanteOcasionalGenTest {

    @BeforeEach 
    void setUp() { 
        new UtilizadorPraticanteOcasional().setProximoCodigo(1); 
    }
'''
    ...
    void {nome}() {{
        ...
        UtilizadorPraticanteOcasional u = new UtilizadorPraticanteOcasional(nome, morada, email, freqCardiaca, peso, altura, dataNascimento, genero);
    ...
    void {nome}() {{
        ...
        UtilizadorPraticanteOcasional original = new UtilizadorPraticanteOcasional(nome, morada, email, freqCardiaca, peso, altura, dataNascimento, genero);
        UtilizadorPraticanteOcasional copia = new UtilizadorPraticanteOcasional(original);
        ...
        assertEquals(1.25, copia.getFatorMultiplicativo(), 0.01);
    }}'''
    ...
    void {nome}() {{
        ...
        UtilizadorPraticanteOcasional original = new UtilizadorPraticanteOcasional(nome, morada, email, freqCardiaca, peso, altura, dataNascimento, genero);
        UtilizadorPraticanteOcasional periodo = new UtilizadorPraticanteOcasional(original, dataInicio, dataFim);
        ...
        assertEquals(1.25, periodo.getFatorMultiplicativo(), 0.01);
    }}'''
    ...
    @Test
    void {nome}() {{
        UtilizadorPraticanteOcasional u1 = new UtilizadorPraticanteOcasional("{nome1}", "{morada1}", "{email1}", {freq1}, {peso1}, {altura1}, 
                                                 LocalDate.of({data1.year}, {data1.month}, {data1.day}), '{genero1}');
        UtilizadorPraticanteOcasional u2 = new UtilizadorPraticanteOcasional("{nome2}", "{morada2}", "{email2}", {freq2}, {peso2}, {altura2}, 
    ...
    @Test
    void {nome}() {{
        UtilizadorPraticanteOcasional original = new UtilizadorPraticanteOcasional("{nome_val}", "{morada_val}", "{email_val}", 
        ...
        assertEquals(1.25, clone.getFatorMultiplicativo(), 0.01);
    ...
    void {nome}() {{
        ...
        UtilizadorPraticanteOcasional periodo = (UtilizadorPraticanteOcasional) original.utilizadorNumPeriodo(dataInicio, dataFim);
    ...
    @Test
    void {nome}() {{
        UtilizadorPraticanteOcasional u = new UtilizadorPraticanteOcasional("{nome_val}", "{morada_val}", "{email_val}", 
                                                    {freq_val}, {peso_val}, {altura_val}, 
                                                    LocalDate.of({data_val.year}, {data_val.month}, {data_val.day}), '{genero_val}');
        ...
        assertTrue(resultado.contains("Praticante Ocasional"));
...
if __name__ == "__main__":
    gen = UtilizadorPraticanteOcasionalJUnitTestGenerator()
